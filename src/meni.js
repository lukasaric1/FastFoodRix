export const meni = [
  ...
  },
  {
    ...
    article: [
      ...
      },
      {
        ...
        price: 7.0,
        contains:
          "Tortilja, šunka, sir, gljive, umak od rajčice / Tortilla, ham, cheese, mushrooms, tomato sauce",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    article: [
      ...
      { name: "Pancerota Nutella", price: 8.5 },
    ],
  },
  {
    name: "KEBAB",
  ...
  },
  {
    ...
    article: [
      {
        name: "Blagi umak / Mild Sauce",
        contains:
          "Majoneza, jogurt, češnjak, začini / Mayonnaise, yogurt, garlic, spices",
      },
      {
        name: "Extra ljuti umak / Extra hot sauce",
        contains: "Čili, kečap, začini / Chilli, ketchup, spices",
      },
    ],
  },
  {
    ...
    id: "soda",
    article: [
      { name: "Coca-cola", amount: "0.33 l", price: 3.0 },
      { name: "Coca-cola / Coca-cola zero", amount: "0.50 l", price: 3.5 },
      { name: "Fanta, Bitter, Sprite", amount: "0.50 l", price: 3.5 },
      { name: "Ledeni čaj", amount: "0.50 l", price: 3.5 },
      { name: "Karlovačko limenka / can", amount: "0.50 l", price: 3.5 },
      { name: "Heineken limenka / can", amount: "0.50 l", price: 3.5 },
      { name: "Voda gazirana / Sparkling water", amount: "0.50 l", price: 3.0 },
      { name: "Voda negazirana / Natural water", amount: "0.50 l", price: 2.5 },
    ],
  },
  {
    name: "DODACI / EXTRAS",
    id: "",
    article: [
      { name: "Pomfrit / French fries", price: 4.5 },
      { name: "Batat / Sweet potato", price: 5.0 },
      { name: "Pršut / Prosciutto", price: 1.0 },
      { name: "Panceta / Bacon", price: 1.0 },
      { name: "Kulen", price: 1.0 },
      { name: "Sir / Cheese", price: 1.0 },
      { name: "Šunka / Ham", price: 1.0 },
      { name: "Tuna", price: 1.0 },
      { name: "Gljive / Mushrooms", price: 1.0 },
    ],
  },
];
